import svgPaths from "./svg-hew4cehkp1";
...
import imgWhatsAppImage20260203At90419Am24 from "@/assets/images/men-working-on-car.png";
import imgWhatsAppImage20260203At90419Am26 from "@/assets/images/slash.png";
import img515721 from "@/assets/images/bae47030fcc0ba864407db8444378e379e4c5fcc.png";
import imgWhatsAppImage20260203At90418Am22 from "@/assets/images/1c94135fbe3911064625628ceff56994ed6b37d7.png";
import imgWhatsAppImage20260203At90420Am21 from "@/assets/images/38652c763718459ec55c07a45a996f5f86f0b07c.png";
import imgImage5 from "@/assets/images/32040281f3eaf43e4f2a928025185e2eb1daa24a.png";
import { imgGroup, imgWhatsAppImage20260203At90419Am23, imgWhatsAppImage20260203At90419Am25 } from "./svg-r8qzf";
...
function Component2() {
  return (
    <div className="bg-[#fefdec] content-stretch flex items-center justify-between px-[20px] py-[10px] relative rounded-[12px] shrink-0 w-[116px]" data-name="Component 3">
      <p className="font-['Neue_Montreal:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#1bad50] text-[14px] text-center">Departments</p>
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[30px] items-center left-[282.89px] top-1/2 w-[874.211px]">
      <p className="font-['Neue_Montreal:Bold',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[50px] text-center text-white w-[min-content] whitespace-pre-wrap">Departments</p>
      <Frame14 />
    </div>
  );
}
...
function HeroSection() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#f7f8fa] h-[600px] left-1/2 overflow-clip top-[100px] w-[1440px]" data-name="Hero Section">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[1098.292px] left-1/2 top-[calc(50%-130px)] w-[1649.729px]" data-name="WhatsApp Image 2026-02-03 at 9.04.17 AM 2">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgWhatsAppImage20260203At90417Am2} />
      </div>
...
function Footer() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#080808] h-[543px] left-1/2 overflow-clip top-[1768px] w-[1440px]" data-name="Footer">
      <Group2 />
...
function Frame9() {
  return (
    <div className="h-[400.386px] relative shrink-0 w-[387.243px]">
      <div className="absolute flex h-[400.386px] items-center justify-center left-0 top-0 w-[387.243px]">
        <div className="-scale-y-100 flex-none">
          <div className="h-[400.386px] relative w-[387.243px]">
            <div className="absolute inset-[0_1.66%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 374.38 400.386">
                <path d={svgPaths.p18167880} fill="var(--fill-0, white)" id="Rectangle 18" />
              </svg>
            </div>
          </div>
        </div>
      </div>
      <div className="-translate-x-1/2 absolute font-['Neue_Montreal:Bold',sans-serif] leading-[0] left-1/2 not-italic text-[0px] text-black text-center top-[339.39px] whitespace-nowrap">
        <p className="leading-[normal] mb-0 text-[20px]">{`(Technical & Operations)`}</p>
        <p className="font-['Neue_Montreal:Regular',sans-serif] leading-[24px] text-[18px]">Business Unit (CNG Programme Delivery)</p>
      </div>
      <div className="absolute h-[319.03px] left-[42.15px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[2.688px_2.193px] mask-size-[297.562px_301.716px] top-[28.18px] w-[478.546px]" data-name="WhatsApp Image 2026-02-03 at 9.04.19 AM (2) 3" style={{ maskImage: `url('${imgWhatsAppImage20260203At90419Am23}')` }}>
...
function Frame10() {
  return (
    <div className="h-[400.386px] relative shrink-0 w-[387.243px]">
      ...
      <div className="-translate-x-1/2 absolute font-['Neue_Montreal:Bold',sans-serif] leading-[0] left-[calc(50%+0.5px)] not-italic text-[0px] text-black text-center top-[339.39px] whitespace-nowrap">
        <p className="leading-[normal] mb-0 text-[20px]">(Finance)</p>
        <p className="font-['Neue_Montreal:Regular',sans-serif] leading-[24px] text-[18px]">Business Unit</p>
      </div>
      <div className="absolute h-[319.03px] left-[42.15px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[2.688px_3.193px] mask-size-[297.562px_301.716px] top-[27.18px] w-[478.546px]" data-name="WhatsApp Image 2026-02-03 at 9.04.19 AM (2) 3" style={{ maskImage: `url('${imgWhatsAppImage20260203At90419Am25}')` }}>
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgWhatsAppImage20260203At90419Am26} />
      </div>
      <div className="absolute left-[27.83px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[17.016px_12.474px] mask-size-[297.562px_301.716px] size-[331.593px] top-[17.9px]" data-name="51572 1" style={{ maskImage: `url('${imgWhatsAppImage20260203At90419Am25}')` }}>
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img515721} />
      </div>
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="h-[400.386px] relative shrink-0 w-[387.243px]">
      ...
      <div className="-translate-x-1/2 absolute font-['Neue_Montreal:Bold',sans-serif] leading-[0] left-[calc(50%-0.5px)] not-italic text-[0px] text-black text-center top-[339.39px] whitespace-nowrap">
        <p className="leading-[normal] mb-0 text-[20px]">(Investment)</p>
        <p className="font-['Neue_Montreal:Regular',sans-serif] leading-[24px] text-[18px]">Business Unit</p>
      </div>
      <div className="absolute h-[319.03px] left-[42.15px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[2.688px_3.193px] mask-size-[297.562px_301.716px] top-[27.18px] w-[478.546px]" data-name="WhatsApp Image 2026-02-03 at 9.04.19 AM (2) 3" style={{ maskImage: `url('${imgWhatsAppImage20260203At90419Am25}')` }}>
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgWhatsAppImage20260203At90419Am26} />
      </div>
      <div className="absolute h-[361.83px] left-[-77.99px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[122.835px_11.593px] mask-size-[297.562px_301.716px] top-[18.78px] w-[542.745px]" data-name="WhatsApp Image 2026-02-03 at 9.04.18 AM (2) 2" style={{ maskImage: `url('${imgWhatsAppImage20260203At90419Am25}')` }}>
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgWhatsAppImage20260203At90418Am22} />
      </div>
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex gap-[20px] items-center left-1/2 top-[150.31px]">
      <Frame9 />
      <Frame10 />
      <Frame11 />
    </div>
...
function Frame12() {
  return (
    <div className="h-[400.386px] relative shrink-0 w-[387.243px]">
      ...
      <div className="-translate-x-1/2 absolute font-['Neue_Montreal:Bold',sans-serif] leading-[0] left-[calc(50%+0.5px)] not-italic text-[0px] text-black text-center top-[339.39px] whitespace-nowrap">
        <p className="leading-[normal] mb-0 text-[20px]">(Compliance)</p>
        <p className="font-['Neue_Montreal:Regular',sans-serif] leading-[24px] text-[18px]">Business Unit</p>
      </div>
      <div className="absolute h-[319.03px] left-[42.15px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[2.688px_2.193px] mask-size-[297.562px_301.716px] top-[28.18px] w-[478.546px]" data-name="WhatsApp Image 2026-02-03 at 9.04.19 AM (2) 3" style={{ maskImage: `url('${imgWhatsAppImage20260203At90419Am23}')` }}>
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgWhatsAppImage20260203At90419Am24} />
      </div>
      <div className="absolute h-[350.958px] left-[-69.98px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[114.817px_45.544px] mask-size-[297.562px_301.716px] top-[-15.17px] w-[526.438px]" data-name="WhatsApp Image 2026-02-03 at 9.04.20 AM (2) 1" style={{ maskImage: `url('${imgWhatsAppImage20260203At90419Am23}')` }}>
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgWhatsAppImage20260203At90420Am21} />
      </div>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="h-[400.386px] relative shrink-0 w-[387.243px]">
      ...
      <div className="-translate-x-1/2 absolute font-['Neue_Montreal:Bold',sans-serif] leading-[0] left-1/2 not-italic text-[0px] text-black text-center top-[339.39px] whitespace-nowrap">
        <p className="leading-[normal] mb-0 text-[20px]">(Corporate Services)</p>
        <p className="font-['Neue_Montreal:Regular',sans-serif] leading-[24px] text-[18px]">Business Unit</p>
      </div>
      <div className="absolute h-[319.03px] left-[42.15px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[2.688px_3.193px] mask-size-[297.562px_301.716px] top-[27.18px] w-[478.546px]" data-name="WhatsApp Image 2026-02-03 at 9.04.19 AM (2) 3" style={{ maskImage: `url('${imgWhatsAppImage20260203At90419Am25}')` }}>
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgWhatsAppImage20260203At90419Am26} />
      ...
      <div className="absolute h-[328.985px] left-[16.38px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[28.459px_15.057px] mask-size-[297.562px_301.716px] top-[15.31px] w-[493.237px]" data-name="image 5" style={{ maskImage: `url('${imgWhatsAppImage20260203At90419Am25}')` }}>
...
function Frame17() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex gap-[20px] items-center left-1/2 top-[590.69px]">
      <Frame12 />
      <Frame13 />
    </div>
  );
...
function Frame1() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex items-end left-1/2 top-[50px]">
      <p className="font-['Neue_Montreal:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#080808] text-[32px]">Pi-CNG Departments</p>
...
function Desktop1() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#f6f6f6] h-[1068px] left-1/2 overflow-clip top-[700px] w-[1440px]" data-name="Desktop - 14">
      <Frame16 />
      <Frame17 />
      <Frame1 />
    </div>
